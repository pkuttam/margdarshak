...
#ifndef MARGDARSHAK_IMUINTERPOLATOR_H
#define MARGDARSHAK_IMUINTERPOLATOR_H
...
public:
    ...
    // arrived.
    void addImage(std::unique_ptr<margdarshak::ImageAndExposure> image, double timestamp);
...
#endif //MARGDARSHAK_IMUINTERPOLATOR_H
